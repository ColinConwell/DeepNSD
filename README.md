# DeepNSD
 ...
 Our Google Colab tutorial ([bit.ly/Deep-NSD-Tutorial](https://bit.ly/Deep-NSD-Tutorial)) provides a step by step demonstration of the main functions in our pipeline, fitting the representations of a [CLIP](https://github.com/openai/CLIP) model to a subset of the fMRI data from a representative subject.
 
 You can use this codebase to quickly load (in a unified API) a number of models and their associated transforms. (Though please note that -- pending further development -- you will have to install the underlying packages manually.) 
